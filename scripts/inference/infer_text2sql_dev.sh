...
dev_pred_dir="spider_train_${train_target}_dev"
...
#    --output_dataset_path "./${dev_dataset_dir}/preprocessed_data/preprocessed_test.json" \
#    --db_path $db_path \
#    --target_type "sql"
#
...
#    --dev_filepath "./${dev_dataset_dir}/preprocessed_data/preprocessed_test.json" \
#    --output_filepath "./${dev_dataset_dir}/preprocessed_data/test_with_probs.json" \
#    --use_contents \
#    --add_fk_info \
#    --mode "test"
#
...
#    --input_dataset_path "./${dev_dataset_dir}/preprocessed_data/test_with_probs.json" \
#    --output_dataset_path "./${dev_dataset_dir}/preprocessed_data/resdsql_test.json" \
#    --topk_table_num 4 \
#    --topk_column_num 5 \
#    --mode "test" \
#    --use_contents \
...
python text2sql.py \
    ...
    --mode "test" \
    --dev_filepath "./${dev_dataset_dir}/preprocessed_data/resdsql_dev.json" \
